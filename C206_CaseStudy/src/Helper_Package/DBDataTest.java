...
// Test DBData Strings
	...
	public void testAllTables() {
		...
		for (String table : allTables) {
			...
			try {
				...
				assertTrue("Table not found: " + se.getMessage(), TablesFound);
				break;
			}
		}
		TablesFound = true;
	...
	public void testAllTablesColumns() {
		...
		String[] admin = new String[] { "admin_id", "admin_profile" };
		String[] child = new String[] { "child_id", "child_name", "child_allegies", "normal_id" };
		String[] has_order = new String[] { "order_id", "order_status", "preference", "child_id", "normal_id",
				"menu_id" };
		String[] item = new String[] { "item_id", "item_name", "item_qty", "item_description", "item_dietary",
				"item_ingredients", "item_price" };
		String[] menu_item = new String[] { "menu_item_id", "item_id", "menu_id" };
		String[] normal = new String[] { "normal_id", "normal_phoneNumber", "normal_address", "normal_profile",
				"normal_allegies" };
		String[] school = new String[] { "school_id", "school_name", "vendor_id", "normal_id" };
		String[] user = new String[] { "user_id", "user_name", "user_email", "user_password", "ACCESS_TYPE",
				"LAST_LOGIN" };
		String[] vendor = new String[] { "vendor_id", "vendor_phoneNumber", "vendor_companyName", "vendor_profile",
				"vendor_address", "menu_id" };

		// Assign Tables Columns into nested array
		String[][] TablesColumns = new String[][] { admin, child, has_order, item, menu_item, normal, school, user,
				vendor };
		...
		for (String table : allTables) {
			...
			try {
				...
				assertTrue("Table with cloumn not found: " + se.getMessage(), TablesFound);
				break;
			}
			CurrentTable++;
		}
